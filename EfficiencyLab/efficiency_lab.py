...
# print("euler5(10): ", answer)
# end_5 = time.time()
# print(f"Time it takes for euler5(10): {(end_5 - start_5)* 1000} ms")
...
# print(f"Time it takes for euler5(20): {(end_10 - start_10)* 1000} ms")
...
# print(f"Time it takes for euler5_better(20): {(end - start)* 1000} ms")
